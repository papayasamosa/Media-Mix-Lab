...
if model_run_id and posterior_params is not None and model_spec_dict is not None:
    ...
    _current_named_event_fit_fp, _current_named_event_classification_fp = (
        named_event_fingerprint_components(current_named_event_fit_inputs)
    )
...
with st.expander("Named-event diagnostics", expanded=False):
    ...
    _ned_families, _ned_occurrences, _ned_definitions = _current_named_event_registry()
